...
const Index = () => {
  return (
    <div className="min-h-screen bg-[#010714] flex">
      {/* Sidebar */}
      <aside className="w-64 bg-[#0A1018]/50 border-r border-[#1a2e44] p-4">
        <div className="mb-8">
          <img 
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="relative flex-1 max-w-xl">
            ...
            <Input 
              ...
              className="pl-10 bg-[#0A1018] border-[#1a2e44] text-white w-full"
            />
          </div>
          <Button 
