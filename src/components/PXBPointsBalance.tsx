...
const PXBPointsBalance: React.FC = () => {
  ...
  return (
    <div className="rounded-lg relative overflow-hidden border border-indigo-900/30 bg-[#0f1628] backdrop-blur-lg">
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/20 to-indigo-600/5"></div>
