        ...
        try {
          ...
          if (data) {
            ...
            const expiresAt = data.expires_at 
              ...
              : new Date(data.created_at).getTime() + data.duration * 1000;
            ...
            const newBet: Bet = {
              ...
              points_amount: data.points_amount || 0,
          ...
          <div className="flex gap-6 items-center animate-scroll">
            {activeBets.map((bet, index) => (
              <Link 
                ...
                className={`flex-shrink-0 flex items-center glass-panel px-3 py-2 rounded-md border ${bet.status === 'expired' ? 'border-amber-500/30' : 'border-white/5'} transition-all duration-500 hover:bg-black/40 
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <div className="flex items-center text-xs bg-dream-accent2/10 px-2 py-0.5 rounded-md">
                      <Zap className="h-3 w-3 mr-1 text-dream-accent2" />
                      <span className="font-semibold">{bet.points_amount} Points</span>
                    </div>
                  </div>
                </div>
              </Link>
