  ...
  return (
    <div className="glass-panel p-6 relative overflow-hidden transition-all duration-300 transform hover:scale-105 animate-fade-in">
      ...
      <div className="flex items-center text-dream-foreground/70 mb-2 relative z-10">
        ...
        <span className="text-lg font-semibold text-white">24h Volume</span>
        {lastUpdated && (
      ...
      <div className={`text-3xl font-bold relative z-10 flex items-center ${pulseEffect ? 'text-dream-accent2 transition-colors duration-500' : 'text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]'}`}>
        {loading ? (
