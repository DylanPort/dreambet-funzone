...
import { Send, Copy, RefreshCw, QrCode, Clock, ArrowUpRight, ArrowDownLeft, Gift, Lock } from 'lucide-react';
...
const PXBWallet: React.FC = () => {
  ...
  return (
    <div className="glass-panel mb-6 overflow-hidden relative rounded-lg bg-[#151c35] border border-indigo-900/50">
      <div className="p-5 flex justify-between items-center border-b border-indigo-900/30">
      ...
      <div className="flex border-b border-indigo-900/30">
        <button
          className={`flex-1 py-3 font-medium flex items-center justify-center gap-2 ${
            activeTab === 'send' ? 'bg-[#1e2747] text-white' : 'text-indigo-300/70 hover:text-white hover:bg-[#1a2340]/50'
          }`}
        ...
        <button
          className={`flex-1 py-3 font-medium flex items-center justify-center gap-2 ${
            activeTab === 'receive' ? 'bg-[#1e2747] text-white' : 'text-indigo-300/70 hover:text-white hover:bg-[#1a2340]/50'
          }`}
        ...
        <button
          className={`flex-1 py-3 font-medium flex items-center justify-center gap-2 ${
            activeTab === 'activity' ? 'bg-[#1e2747] text-white' : 'text-indigo-300/70 hover:text-white hover:bg-[#1a2340]/50'
          }`}
      ...
      <div className="p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  className="bg-[#1e2747] border-indigo-900/30 text-white"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    type="number"
                    min="1"
                    className="bg-[#1e2747] border-indigo-900/30 text-white pr-12"
                  />
              ...
              <div className="flex items-center justify-between text-xs text-indigo-300/50 mt-4 border-t border-indigo-900/30 pt-4">
                <div className="flex items-center gap-1">
                  <Lock className="w-3 h-3" />
                  Locked:
                </div>
                <div className="font-mono">09:35</div>
              </div>
            </div>
          </motion.div>
        )}
        ...
        {activeTab === 'receive' && (
          ...
          >
            <div className="w-40 h-40 bg-[#1e2747] rounded-lg mb-4 flex items-center justify-center">
              <QrCode className="w-20 h-20 text-indigo-300/70" />
            </div>
            
            <p className="text-sm text-indigo-300/70 mb-2">Your PXB ID</p>
            <div className="w-full bg-[#1e2747] rounded-lg p-3 flex justify-between items-center mb-6">
        ...
        {activeTab === 'activity' && (
          ...
          >
            <div>
              ...
              {isLoadingTransactions ? (
                ...
                <div className="space-y-3">
                  {transactions.map((tx) => (
                    <div 
                      key={tx.id} 
                      className="flex items-center justify-between p-3 bg-[#1e2747] rounded-lg hover:bg-[#1a2340] transition-colors"
                    >
                      <div className="flex items-center">
              ...
              <Button 
                variant="outline" 
                className="w-full mt-4 border-indigo-900/30 text-indigo-300/70 hover:text-white hover:bg-[#1e2747]"
        ...
        {activeTab === 'claim' && (
          ...
          >
            <div className="flex flex-col items-center py-6">
              ...
              {cooldownRemaining ? (
                <div className="text-center mb-6 p-6 bg-[#1e2747] rounded-lg w-full max-w-md">
                ...
                <Button 
                  ...
                  disabled={isClaiming}
                  className="w-full max-w-md bg-green-600 hover:bg-green-700 mb-4"
                  size="lg"
                >
                  {isClaiming ? (
                    <div className="flex items-center gap-2">
                    ...
                    <>
                      <img src="/lovable-uploads/be886d35-fbcb-4675-926c-38691ad3e311.png" alt="PXB Coin" className="w-5 h-5" />
