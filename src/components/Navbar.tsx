  ...
  return <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'backdrop-blur-lg bg-dream-background/80 shadow-lg' : ''}`}>
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
        <div className="flex justify-between items-center py-2">
          <Link to="/" className="text-lg font-display font-bold text-gradient mx-px px-[3px] my-[2px] py-[5px]">
            PumpXBounty
          </Link>
          ...
          <nav className="hidden md:flex space-x-4 items-center">
            ...
            {pxbPoints !== null && pxbPoints > 0 ? <div className="glass-panel relative overflow-hidden py-0.5 px-2 flex items-center gap-1 text-yellow-400 group animate-pulse-subtle">
              ...
              </div> : userProfile && <div className="glass-panel py-0.5 px-2 flex items-center gap-1 text-yellow-400/70">
                <div className="w-6 h-6 flex items-center justify-center">
                  <img src="/lovable-uploads/be886d35-fbcb-4675-926c-38691ad3e311.png" alt="PXB Coin" className="w-8 h-8 filter drop-shadow-[0_0_8px_rgba(139,92,246,0.8)]" />
                </div>
      ...
      {isOpen && <div className="md:hidden glass-panel p-4">
          <nav className="flex flex-col space-y-3">
            <Link to="/betting" className={`py-1.5 flex items-center gap-2 ${location.pathname.includes('/betting') || location.pathname.includes('/token') ? 'text-dream-accent2' : 'text-dream-foreground/70'}`}>
              <div className="w-8 h-8 flex items-center justify-center transition-transform hover:scale-105">
                <img src="/lovable-uploads/0ac8fb50-def8-4e80-8f31-1c24a76d49de.png" alt="Betting" className="w-full h-full object-contain drop-shadow-[0_0_8px_rgba(255,61,252,0.5)]" />
              </div>
              <span>Betting</span>
            </Link>
            <Link to="/betting/my-bets" className={`py-1.5 flex items-center gap-2 ${location.pathname === '/betting/my-bets' ? 'text-dream-accent2' : 'text-dream-foreground/70'}`}>
              <div className="w-8 h-8 flex items-center justify-center transition-transform hover:scale-105">
            ...
            <Link to="/profile" className={`py-1.5 flex items-center gap-2 ${location.pathname === '/profile' ? 'text-dream-accent2' : 'text-dream-foreground/70'}`}>
            ...
            {pxbPoints !== null && pxbPoints > 0 ? <div className="py-1.5 flex items-center gap-2 text-yellow-400 animate-pulse-subtle">
              ...
              </div> : userProfile && <div className="py-1.5 flex items-center gap-2 text-yellow-400/70">
                <div className="w-8 h-8 flex items-center justify-center">
                  <img src="/lovable-uploads/be886d35-fbcb-4675-926c-38691ad3e311.png" alt="PXB Coin" className="w-10 h-10 filter drop-shadow-[0_0_8px_rgba(139,92,246,0.8)]" />
                </div>
                <span className="text-sm">0 PXB</span>
            ...
            {balance !== null && <div className="py-1.5 flex items-center gap-2 text-green-400">
                <div className="w-8 h-8 flex items-center justify-center">
