...
const Footer = () => {
  ...
  return <footer className="mt-20 border-t border-white/10 bg-gradient-to-t from-dream-background/80 to-transparent backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col items-center md:items-start">
            <div className="relative flex items-center">
              <img src="/lovable-uploads/b202d0ff-b32c-4588-9d6a-772fb5cbbe0b.png" alt="PumpXBounty" className="h-8 md:h-10" />
            </div>
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex space-x-4">
              <TooltipProvider>
                {socialLinks.map(link => <Tooltip key={link.name}>
                    <TooltipTrigger asChild>
                      <a href={link.url} target="_blank" rel="noopener noreferrer" className="bg-dream-card/50 p-2 rounded-full hover:bg-dream-accent3/20 transition-all duration-300 hover:scale-110 flex items-center justify-center group relative overflow-hidden">
